...
const socialLinks: SocialLinkData[] = [
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/ranveer-shah333",
    svg: (
      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/ranveer_s0/",
    svg: (
      <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const SocialLinks: FunctionComponent = () => {
  ...
  return (
    <div className={styles.socialContainer}>
      ...
      <div className={styles.socialLinks}>{socialLinksComponents}</div>
    </div>
  );
};
